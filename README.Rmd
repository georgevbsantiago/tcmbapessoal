...
5 - Exportar o resultado do Scraping para um repositório público para que qualquer pessoa possa baixar os dados.
...
3º - Aprimorar elementos da Documentação
...
!!! Mudar a lógica da rotina de verificação em " if (file.exists(file.path("bd_sqlite", "bd_tcm_folha_pessoal_municipios.db")) == FALSE)" para algo mais genérico, já que o código, agora, é agnóstico.

!!! Determinar quais funções necessitam ser exportadas
...
!!! Restruturar o print para sinalizar o Scraping
