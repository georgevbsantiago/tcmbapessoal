...
Neste Web Scraping, esfrentamos um defasio de razoável dificuldade técnica *Muitas buscas e uma paginação por busca*, pelo menos do ponto de vista da arquitetura de execução do código.
